  ...
  render() {
    return (
      <div>
        ...
        <h2>Today </h2>
        { /* Change code below this line */ }
        <List tasks={["first", "second"]}/>
        <h2>Tomorrow </h2>
        <List tasks={["sleep", "eat", "code", "repeat"]}/>
        { /* Change code above this line */ }
      </div>
    );
  }
...
class Camper extends React.Component {
  ...
  render() {
    return (
      <div>What a <p>{this.props.name}</p></div>   
    )
  }
}
...
```
Had problems with the html window going blank, found a link to a post that explained what happened:
...
class Results extends React.Component {
  ...
  render() {
    ...
    {/* Change code below this line */}
    const text = this.props.fiftyFifty?"You Win!":"You Lose!";
    return <h1>{text}</h1>;
    {/* Change code above this line */}
  }
}
...
function Frameworks() {
  const renderFrameworks = frontEndFrameworks.map(element => <li key={"li"+frontEndFrameworks.indexOf(element)} >{element}</li>); // Change this line
  return (
    <div>
...
class MyComponent extends React.Component {
  ...
  render() {
    ...
    const renderOnline = usersOnline.map(element => <li key={element.username}>{element.username}</li>)// Change this line
    return (
      <div>
